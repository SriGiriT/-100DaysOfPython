...
tick_img = PhotoImage(file='flash-card-project-start/images/right.png')
known_button = Button(image=tick_img, highlightthickness=0, bg=BACKGROUND_COLOR, command=is_know)
